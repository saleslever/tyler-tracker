...
export async function ensureSchema() {
  await pool.query(`
    ...
    ALTER TABLE daily_logs ADD COLUMN IF NOT EXISTS fast_completed INTEGER NOT NULL DEFAULT 0;
    ALTER TABLE daily_logs ADD COLUMN IF NOT EXISTS steps_completed INTEGER NOT NULL DEFAULT 0;
